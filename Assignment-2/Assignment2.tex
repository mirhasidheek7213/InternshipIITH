...
\noindent Find the equation of the line, which makes intercepts $-3$ and $2$ on the $x$ and $y$ axes respectively.
%
\section{Solution}
\begin{equation}
...
\end{equation}
\\
Hence , the line cuts through the x-axis at \myvec{-3\\ 0} and the line cuts through the y-axis at \myvec{0\\ 2}
\\


\begin{align}
    A= \myvec{-3\\ 0} , B= \myvec{0\\ 2}
\end{align}
...
=\myvec{3\\2}
      \end{equation} 
\\
Hence, the equation of line by substituting \ref{eq:1} is,
\begin{equation}
    r=\myvec{-3\\ 0}+\lambda{\myvec {3 \\2}}  
\end{equation}
\\
...
\begin{figure}[!h]
         ...
         \caption{The line $r=\myvec{-3\\ 0}+\lambda{\myvec {3 \\2}}$ }
         \label{Figure}
\end{figure}
\end{document}
